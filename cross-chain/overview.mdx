...
<img className="block dark:hidden mx-auto" src="/images/diagrams/cross-chain-integration-light.svg" alt="Injective × Cascade Integration Shape" />
<img className="hidden dark:block mx-auto" src="/images/diagrams/cross-chain-integration-dark.svg" alt="Injective × Cascade Integration Shape" />
