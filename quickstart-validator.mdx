...
|-----------|---------|---------|
| CPU | 4 vCPU (x86_64) | 8 cores (x86_64) |
| RAM | 8 GB | 32 GB |
...
- **Provision a server.** Ubuntu 22.04 LTS or later on x86_64 hardware that meets the table above.
...
- [Testnet validator guide](/validators-testnet/overview) covers `lumera-testnet-2`, currently on `v1.20.1` with the EVM live.
- [Mainnet validator guide](/validators-mainnet/overview) covers `lumera-mainnet-1`, currently on `v1.12.0`.
...
<CardGroup cols={3}>
  ...
  <Card title="Mainnet guide" icon="server" href="/validators-mainnet/overview">
