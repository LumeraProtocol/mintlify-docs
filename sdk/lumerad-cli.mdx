---
title: "lumerad CLI Reference: Keys, Queries, and Transactions"
sidebarTitle: "lumerad CLI"
description: "Complete reference for the lumerad command-line tool: query chain state, submit transactions, manage keys, and work with Lumera modules."
---
