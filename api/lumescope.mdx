---
title: "Deploy LumeScope with Docker"
sidebarTitle: "LumeScope"
description: "Run your own LumeScope instance with Docker to aggregate Lumera action metadata, SuperNode metrics, and network stats."
---
