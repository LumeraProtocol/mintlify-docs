...
<img className="block dark:hidden mx-auto" src="/images/diagrams/node-architecture-light.svg" alt="Node.js Browser-First Architecture" />
<img className="hidden dark:block mx-auto" src="/images/diagrams/node-architecture-dark.svg" alt="Node.js Browser-First Architecture" />
