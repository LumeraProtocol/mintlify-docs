...
<img className="block dark:hidden mx-auto" src="/images/diagrams/sdk-architecture-light.svg" alt="JavaScript SDK Architecture" />
<img className="hidden dark:block mx-auto" src="/images/diagrams/sdk-architecture-dark.svg" alt="JavaScript SDK Architecture" />
