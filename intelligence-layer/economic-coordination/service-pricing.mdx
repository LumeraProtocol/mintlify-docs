...
## Expired actions refund

If an action expires before finalization, the escrowed service fee returns to the creator. You pay gas for the attempt and nothing for the service. See [Escrow and settlement](/intelligence-layer/economic-coordination/escrow-and-settlement).
