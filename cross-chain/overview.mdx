...
<img className="block dark:hidden mx-auto" src="/images/diagrams/cross-chain-integration-light.svg" alt="Cross-chain integration shape" />
<img className="hidden dark:block mx-auto" src="/images/diagrams/cross-chain-integration-dark.svg" alt="Cross-chain integration shape" />
