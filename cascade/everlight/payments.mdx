...
<img
  ...
  alt="Everlight funding and payout flow"
  src="/images/diagrams/everlight-flow-light.svg"
/>
<img
  className="mx-auto hidden dark:block"
  alt="Everlight funding and payout flow"
  src="/images/diagrams/everlight-flow-dark.svg"
/>
...
<CardGroup cols={2}>
  <Card title="For SuperNode operators" icon="server" href="/cascade/everlight/supernode-operators">
    The STORAGE\_FULL state and what payouts mean for your node.
  </Card>
