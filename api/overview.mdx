---
title: "Lumera Protocol REST API Overview: LumeScope and LCD"
sidebarTitle: "Overview"
description: "Lumera Protocol exposes REST APIs via LumeScope and the lumerad LCD endpoint. Learn about base URLs, authentication, and rate limits."
---
