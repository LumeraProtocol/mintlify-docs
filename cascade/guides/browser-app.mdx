...
<img className="block dark:hidden mx-auto" src="/images/diagrams/node-architecture-light.svg" alt="Browser-first Cascade architecture" />
<img className="hidden dark:block mx-auto" src="/images/diagrams/node-architecture-dark.svg" alt="Browser-first Cascade architecture" />
