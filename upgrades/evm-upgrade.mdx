...
The v1.20.0 release, named Aurora Convergence, added full EVM compatibility to Lumera Protocol. It shipped on June 25, 2026 and is live on mainnet and testnet. This page explains what changed and what existing users and operators need to do.
...
See the [smart contracts overview](/smart-contracts) for the developer view of these features.
...
| `v1.20.1-hotfix` | July 14, 2026 | Current release |
...
<CardGroup cols={2}>
  ...
  <Card title="Validator operations" icon="shield" href="/validators/operations">
