---
title: "SupernodeService gRPC reference"
sidebarTitle: "SupernodeService"
description: "Query system status and resource metrics for a Lumera SuperNode over gRPC, including CPU, memory, storage, P2P, and DHT data."
---
