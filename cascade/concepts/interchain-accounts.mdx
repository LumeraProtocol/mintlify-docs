...
<img className="block dark:hidden mx-auto" src="/images/diagrams/interchain-accounts-light.svg" alt="Interchain Accounts (ICA) Flow" />
<img className="hidden dark:block mx-auto" src="/images/diagrams/interchain-accounts-dark.svg" alt="Interchain Accounts (ICA) Flow" />
