---
title: "LumeScope Actions API reference"
sidebarTitle: "Actions API"
description: "Query Cascade and Sense actions on the Lumera network with decoded metadata, lifecycle details, and aggregated statistics."
---
