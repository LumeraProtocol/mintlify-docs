...
<img className="block dark:hidden mx-auto" src="/images/diagrams/pattern-user-signed-light.svg" alt="Pattern A user signed Cascade write" />
<img className="hidden dark:block mx-auto" src="/images/diagrams/pattern-user-signed-dark.svg" alt="Pattern A user signed Cascade write" />
...
<img className="block dark:hidden mx-auto" src="/images/diagrams/pattern-server-signed-light.svg" alt="Pattern B server signed via a backend" />
<img className="hidden dark:block mx-auto" src="/images/diagrams/pattern-server-signed-dark.svg" alt="Pattern B server signed via a backend" />
