---
title: "Lumera Hub: Your Gateway to the Lumera Ecosystem"
sidebarTitle: "Overview"
description: "Lumera Hub is the official cross-platform application for the Lumera network. Available as a web app, desktop app, and mobile app."
---
...
<CardGroup cols={3}>
  ...
  <Card
    title="Desktop App"
    icon="desktop"
    href="https://github.com/LumeraProtocol/lumera-hub"
  >
    Install the native desktop application for **Windows, macOS, or Linux**, built with Tauri for a lightweight, high-performance experience.
  </Card>
  <Card
    title="Mobile App"
    icon="mobile"
    href="https://github.com/LumeraProtocol/lumera-hub"
  >
    Manage your wallet and interact with the network on **iOS or Android**, built with Expo for a smooth native mobile experience.
  </Card>
</CardGroup>
