...
<Steps>
  ...
  <Step title="Request tokens">
    Open the [faucet](https://portal.testnet.lumera.io/lumera-testnet-2/faucet), paste your address, and submit the request. The faucet limits requests per wallet per day.
  </Step>
