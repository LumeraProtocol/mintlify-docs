...
<img className="block dark:hidden mx-auto" src="/images/diagrams/execution-environments-light.svg" alt="Three execution environments on one chain" />
<img className="hidden dark:block mx-auto" src="/images/diagrams/execution-environments-dark.svg" alt="Three execution environments on one chain" />
