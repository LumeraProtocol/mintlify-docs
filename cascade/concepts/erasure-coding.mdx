...
<img className="block dark:hidden mx-auto" src="/images/diagrams/erasure-coding-light.svg" alt="RaptorQ Encoding Flow" />
<img className="hidden dark:block mx-auto" src="/images/diagrams/erasure-coding-dark.svg" alt="RaptorQ Encoding Flow" />
