...
| **LCD (REST)** | Coming soon | Coming soon |

## EVM access

Since `v1.20.0`, every node enables the EVM JSON-RPC server and OpenRPC discovery by default, so a node you run also serves Ethereum tooling such as Hardhat and Foundry. See [Smart contracts](/smart-contracts) for deployment guides.
...
<CardGroup cols={3}>
  ...
  <Card title="Validator setup" icon="shield-check" href="/validators/setup">
